// Port of lib/server/tencent-speech.ts: TC3 signing + SentenceRecognition.
// No audio URLs, models or keys are accepted from callers; credentials come
// from function environment variables only.
...
export async function voiceHmac(key, text) {
...
export async function tencentSpeechHeaders(body, credentials, timestamp) {
