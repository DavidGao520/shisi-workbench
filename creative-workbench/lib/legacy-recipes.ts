...
// Immutable fallback for sessions saved before snapshots existed. Never update these
// quantities or steps when publishing a new cookbook; old consumption must stay exact.
export const LEGACY_RECIPE_VERSION = '2026-09-05-draft.1';
